...
const RightPanel = () => {
  ...
  return (
    <div className="relative hidden lg:block my-4 mx-5">
      <div className="mb-4" ref={inputRef}>
        <label className="input rounded-full border-2 border-slate-100 text-slate-100">
      ...
      {searchTerm && !isLoading && (
        <div className="absolute  flex-flex-col w-full max-h-50 overflow-y-scroll gap-4 bg-[#16181C] z-10 rounded-md p-4">
      ...
      <div className={`bg-[#16181C] sticky top-2 rounded-md p-4 ${searchTerm && "opacity-0"}`}>
